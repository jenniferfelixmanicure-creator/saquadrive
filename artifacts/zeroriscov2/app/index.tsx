...
import Svg, {
  Circle, Path, Line, Ellipse, Defs, LinearGradient as SvgLinearGradient,
  Stop, G,
  ...
  return (
    <Svg width={90} height={90} viewBox="0 0 90 90">
      ...
      <G transform="translate(18, 32)">
        ...
        <Path d="M4 28C4 21 8 17 15 17C22 17 26 21 26 28" fill="url(#pGrad)" />
        <Path d="M24 20 C28 17 30 13 27 10" stroke="url(#pGrad)" strokeWidth="3" strokeLinecap="round" fill="none" />
...
function DriverIllustration() {
  return (
    <Svg width={90} height={90} viewBox="0 0 90 90">
      ...
      <Path d="M36 45 C34 42 32 40 19 40" stroke="url(#dGrad)" strokeWidth="3.5" strokeLinecap="round" fill="none" />
      <Path d="M52 38 C54 35 55 32 64 23" stroke="url(#dGrad)" strokeWidth="3.5" strokeLinecap="round" fill="none" />
      <Path d="M52 52 C54 55 55 58 64 67" stroke="url(#dGrad)" strokeWidth="3.5" strokeLinecap="round" fill="none" />
...
const styles = StyleSheet.create({
  ...
  illustrationBox: { width: 90, height: 90, alignItems: "center", justifyContent: "center" },
  ...
  footerText: {
    fontSize: 12, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.35)",
  },
});
